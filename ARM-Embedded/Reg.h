...
// data register
#define UARTDR *((volatile u32*)0x4000C000)
// Flag register
#define UARTFR *((volatile u32*)0x4000C018)
// baud rate integer 
#define UARTIBRD *((volatile u32*)0x4000C024)
// baud rate fraction
#define UARTFBRD *((volatile u32*)0x4000C028)
// uart line control
#define UARTLCRH *((volatile u32*)0x4000C02C)
// uart control
#define UARTCTL *((volatile u32*)0x4000C030)
// interrupt mask
#define UARTIM *((volatile u32*)0x4000C038)
/*************************         NVIC      *************************/
#define NVIC_EN0 *((volatile u32*)E000E100)
